...
Sélectionner avec le bouton 'choix json' le json : 'test.JSON' dans './programmes/...'.
Sélectionner la difficulté de votre choix. (le mode facile ne fonctionne pas encore)
